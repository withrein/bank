...
const ENTRY_CSS = "./assets/index-c2ca781c.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-911d1d3f.js').then(n => n.I),true?["./Index-911d1d3f.js","./Index-ab093f07.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-457a826a.js.map
