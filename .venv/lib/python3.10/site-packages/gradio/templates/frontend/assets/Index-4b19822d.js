import { P as Prism$1 } from './prism-python-2f196ac7.js';
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			...
			t2 = text("= ");
			html_tag = new HtmlTag(false);
			attr(span, "class", "svelte-o0cc7h");
			set_style(span, "padding-right", "4px");
			html_tag.a = null;
			attr(code, "class", "svelte-o0cc7h");
			attr(div, "class", "default svelte-o0cc7h");
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			...
			p = element("p");
			t = text(t_value);
			attr(div, "class", "description svelte-o0cc7h");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, p);
...
function create_each_block(key_1, ctx) {
	...
	return {
		...
		c() {
			...
			t4 = space();
			attr(code, "class", "svelte-o0cc7h");
			attr(pre, "class", pre_class_value = "language-" + /*lang*/ ctx[0] + " svelte-o0cc7h");
			attr(button, "class", "arrow svelte-o0cc7h");
			toggle_class(button, "hidden", !/*show_desc*/ ctx[3][/*i*/ ctx[15]]);
			attr(div0, "class", "type svelte-o0cc7h");
			attr(div1, "class", "param md svelte-o0cc7h");
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*lang*/ 1 && pre_class_value !== (pre_class_value = "language-" + /*lang*/ ctx[0] + " svelte-o0cc7h")) {
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "wrap svelte-o0cc7h");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
//# sourceMappingURL=Index-4b19822d.js.map
